...
class VecNormalize(VecEnvWrapper):
  ...
  def _sanity_checks(self) -> None:
    ...
    if isinstance(self.observation_space, spaces.Dict):
      ...
      raise ValueError("VecNormalize only supports `gym.spaces.Box` and `gym.spaces.Dict` observation spaces, " f"not {self.observation_space}")
  ...
  def step_wait(self) -> State:
    ...
    return State(obs=obs, reward=rewards, done=dones, info=infos)
